...
void quadratic_solve::solve()
{
	...
	solution_vector.push_back(y1);
	solution_vector.push_back(y2);
}

vector<double> quadratic_solve::get_solution()
{
    cout << "Solution: Qudtratic Solution" << endl;
